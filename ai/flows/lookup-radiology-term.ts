...
/**
 * @fileOverview A dedicated Genkit flow for looking up a single term from the clinical knowledge base.
...
/**
 * Looks up a radiological term using the clinical knowledge base service.
