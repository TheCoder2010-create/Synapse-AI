...
const faqs = [
  ...
  },
  {
    ...
    answer: "This is a key feature of our data enrichment pipeline. Our proprietary Synapse Wrapper API connects to multiple external knowledge bases and anatomical atlases. The AI is programmed to cross-reference its findings with these sources, and our API returns this structured, verified data."
  },
  {
