...
export const AISegmentationOutputSchema = z.object({
  segmentationData: z.array(SegmentationPartSchema).nullable().describe('An array of labeled segmentation parts, or null if no segmentation is found.'),
});
